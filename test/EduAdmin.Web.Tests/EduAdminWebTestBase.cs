...
{
    public abstract class EduAdminWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static EduAdminWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(EduAdminWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<EduAdminDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<EduAdminDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<EduAdminDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<EduAdminDbContext, Task<T>> func)
        {
            T result;
